...
export const apartmentData = {
  ...
  badges: [
    ...
    },
    {
      ...
      description: "Reduce water usage by 1000 liters",
      progress: 24,
    },
    {
      name: "perfect_week",
      ...
      description: "Kept Green Index above 80%",
      progress: 70,
    },
    {
      name: "new_record",
      title: "New Record",
      img: "/new-record.png",
      description: "Improved Green Index by 10%",
      progress: 10,
    },
    {
      ...
      description: "Top-1 in the Neighborhood",
      progress: 88,
    },
  ],
  devices: [
